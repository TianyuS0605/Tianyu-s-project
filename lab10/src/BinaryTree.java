...
public class BinaryTree<T> {
    ...
    public int height() {
        ...
        if (root == null) {
            ...
            return 1 + Math.max(new BinaryTree<T>(root.left).height(), new BinaryTree<T>(root.right).height());
        }
    }
    ...
    public boolean isCompletelyBalanced() {
        ...
        if (left.isCompletelyBalanced() && right.isCompletelyBalanced() && left.height() == right.height()) {
            return true;
        }
        return false;
    }
    ...
    public static BinaryTree<Integer> fibTree(int N) {
        ...
        result.root = new TreeNode<Integer>(left.root.item + right.root.item);
    ...
    public static void main(String[] args) {
        ...
        print(fibTree(4), "fib tree height 4");
        t.sampleTree1();
