...
public class MemoryGame {
    ...
    public String generateRandomString(int n) {
        ...
        String randomString = "";
        for (int i = 0; i < n; i++) {
            randomString += CHARACTERS[RandomUtils.uniform(rand, 26)];
        }
        return randomString;
    }
...
//            StdDraw.pause(1000);
//            String stringToDisplay = generateRandomString(this.round);
//            flashSequence(stringToDisplay);
//            String inputString = solicitNCharsInput(this.round);
//            if (!stringToDisplay.equals(inputString)) {
//                gameOver = true;
//            }
//            this.round++;
//        }
