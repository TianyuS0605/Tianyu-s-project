...
public class DLListTest {
    ...
    @Test
    public void testDLListReverse() {
        DLListFactory<Integer> factory = new DLListFactory<Integer>();
        DLList<Integer> test1 = factory.of(1, 3, 5);
        DLList<Integer> test2 = factory.of(1);
        DLList<Integer> test3 = new DLList<Integer>();

        test1.reverse();
        assertWithMessage("Size was not equal to 5").that(test1).isEqualTo(factory.of(5, 3, 1));
        test2.reverse();
        assertWithMessage("Second item was not 3").that(test2).isEqualTo(factory.of(1));
        test3.reverse();
        assertWithMessage("Third item was not 4").that(test3).isEqualTo(factory.of());
    }
}
